...
map_output_directory = base_directory / "MapOutputFolder" 
map_output_directory.mkdir(parents=True, exist_ok=True) # creo nel caso non esista
...
def main():
    ...
    directory_risultati = base.parent / "data/ORS_data" # Directory dove sono salvati i risultati delle query Overpass
